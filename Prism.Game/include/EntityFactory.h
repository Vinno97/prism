...
public:
	...
	unsigned createResourcePoint(ECS::EntityManager& entityManager, Enums::ResourceType type, int gatherRate,
	                             float value) const;
	unsigned createResourcePoint(unsigned entity, ECS::EntityManager& entityManager, Enums::ResourceType type,
	                             int gatherRate, float value) const;
	...
	unsigned createEnemySpawn(unsigned entity, ECS::EntityManager& entityManager, float spawnInterval,
	                          bool enabled) const;
	...
	unsigned createResourceBlob(unsigned entity, ECS::EntityManager& entityManager, Enums::ResourceType type,
	                            float value) const;
