...
void World::Assemblers::MineAssembler::assemble(int entity, const WorldObject& worldObject,
...
void World::Assemblers::MineAssembler::disassemble(int entity, WorldObject& worldObject,
