...
class VertexArrayObject {
 public:
  ...
  /// </summary>
  /// <remarks>
  /// Right now this class does not support intervals between strides and
  /// different storage types. This may be added when necessary.
  /// </remarks>
  /// <param name="vertexBuffer">Buffer to add to VAO</param>
  /// <param name="index">Position of input variable in the vertex
  /// shader</param> <param name="size">Size of each block of data</param>
